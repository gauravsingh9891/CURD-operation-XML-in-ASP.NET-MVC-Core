...
namespace MVCDHProject.Models
{
    public class CustomerXmlDAL
    {
        ...
        //Logic to display all customer records
        ...
        //Logic to display single customer record based on custid
        public Customer Customer_Select(int Custid)
        {
            //Finding a DataRow based on its Primary Key value
            DataRow? dr = ds.Tables[0].Rows.Find(Custid);        //Find method will only work when primary key is available
        ...
        public void Customer_Update(Customer customer)
        {
            ...
            //Overriding the old values in DataRow with new values based on index
        ...
        //Logic to Delete customer based on custid
